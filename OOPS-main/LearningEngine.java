...
public class LearningEngine {
    ...
    public LearningEngine(double learningFactor,
        ...
        // loadFromFile() was static and used a static filePath field that may
        //  not have been set yet, causing a NullPointerException.
        // TaskSelectionHistory already calls loadFromFile() inside its own
        //   constructor, so this was a redundant double-load anyway.
    }
